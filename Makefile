...
BUILD_FLAGS  = -fPIC -O2 -DLVRT -DVST6432 -DXECLOSE -DEMBED -DEMBEDDRAG -DWAVES -DVESTIGE -DNEWTIME -DINOUTMEM -DCHUNKBUF -DTRACKTIONWM -DEMBEDRESIZE $(CXX_FLAGS)
...
BUILD_FLAGS_WIN = -m64 -O2 -DVST6432 -DXECLOSE -DEMBED -DEMBEDDRAG -DWAVES -DVESTIGE -DNEWTIME -DINOUTMEM -DCHUNKBUF -DTRACKTIONWM -DEMBEDRESIZE -I/usr/include/wine-development/windows -I/usr/include/wine-development/wine/windows -I/usr/include/wine/wine/windows
# add -DEMBEDRESIZE to the above line for window resizing
BUILD_FLAGS_WIN32 = -m32 -O2 -DVST6432 -DXECLOSE -DEMBED -DEMBEDDRAG -DWAVES -DVESTIGE -DNEWTIME -DINOUTMEM -DCHUNKBUF -DVST32SERVER -DTRACKTIONWM -DEMBEDRESIZE -I/usr/include/wine-development/windows -I/usr/include/wine-development/wine/windows -I/usr/include/wine/wine/windows
# add -DEMBEDRESIZE to the above line for window resizing
