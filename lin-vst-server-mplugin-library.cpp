...
RemoteVSTServer::RemoteVSTServer(std::string fileIdentifiers,
    ...
    : RemotePluginServer(fileIdentifiers), m_name(fallbackName), m_maker(""),
      ...
      hidegui(0), ghWriteEvent(0), ghWriteEvent2(0), ghWriteEvent3(0),
      ghWriteEvent4(0), ghWriteEvent5(0), ghWriteEvent7(0), libHandle(0),
      m_plugin(0), pidx(0), plugerr(0), debugLevel(RemotePluginDebugNone) {
  ThreadHandle[0] = 0;
  ThreadHandle[1] = 0;
  ThreadHandle[2] = 0;
